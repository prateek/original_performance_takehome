...
- Current best is **`1362` cycles** on the authoritative harness (`python tests/submission_tests.py`).
- This beats the `Readme.md` benchmark of **`1363` cycles** (needs `< 1363`, i.e. `1362` or better).
